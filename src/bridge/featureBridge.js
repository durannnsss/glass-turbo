...
module.exports = {
  ...
  initialize() {
    ...
    ipcMain.handle('settings:setActivePreset', async (e, presetId) => await settingsService.setActivePreset(presetId));
    ipcMain.handle('settings:getActivePreset', async () => await settingsService.getActivePreset());
